...
const Component: NextPage = () => (
  <section className="py-16 px-4 prose prose-headings:text-blue">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Jamie Kieran Martin.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Jamie Kieran Martin, accessible
          from{" "}
          <a
            href="https://jamiekieranmart.in"
            rel="external nofollow noopener noreferrer"
            target="_blank"
          >
            <mark>https://jamiekieranmart.in</mark>
          </a>
        </p>
      </li>
      <li>
